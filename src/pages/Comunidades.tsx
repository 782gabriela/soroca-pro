        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mb-8 text-lg leading-relaxed text-muted-foreground">
              Ofrecemos soluciones integrales de mantenimiento y rehabilitación para comunidades de
              propietarios. Nos encargamos de fachadas, cubiertas, zonas comunes e instalaciones
              comunitarias. Un solo interlocutor gestiona cada gremio implicado para que la
              comunidad no tenga que preocuparse de nada.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            <h2 className="mb-8 text-2xl font-bold text-foreground sm:text-3xl">
              ¿Qué podemos hacer por tu comunidad?
            </h2>
      ...
      <section className="bg-muted/30 py-16 md:py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="mb-4 text-2xl font-bold text-foreground sm:text-3xl">
            ¿Tu comunidad necesita un presupuesto?
          </h2>
          <p className="mx-auto mb-8 max-w-lg text-muted-foreground">
            Cuéntanos las necesidades de tu comunidad y te preparamos una propuesta detallada.
          </p>
          <Button asChild size="lg">
