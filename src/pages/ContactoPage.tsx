          ...
          <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2">
            <div className="flex flex-col gap-6">
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <a href="tel:+34655020020" className="text-lg font-medium text-primary hover:underline">
                  655 020 020
                </a>
              </div>
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <a href="mailto:info@gruposoroca.es" className="text-lg font-medium text-primary hover:underline">
                  info@gruposoroca.es
                </a>
              </div>
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <p className="text-muted-foreground">Provincia de Alicante, España</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <Button asChild variant="outline">
                  <Link to="/horario">Consulta nuestro horario</Link>
                </Button>
              </div>
