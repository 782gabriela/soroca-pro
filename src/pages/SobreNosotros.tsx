      ...
      <main className="flex-1">
        <section className="bg-gradient-to-b from-primary/5 to-background pt-20 pb-12 md:pt-28 md:pb-16">
          <div className="container mx-auto px-4 font-sans">
            <div className="mx-auto max-w-3xl bg-primary-foreground">
              ...
              <p className="text-base font-normal leading-[1.75] text-foreground/90 md:text-lg font-sans" style={{ maxWidth: '780px' }}>{t.sobreNosotros.subtitle}</p>
            </div>
          </div>
        </section>
            ...
            <div className="mx-auto max-w-5xl">
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div key={item.title} className="rounded-2xl border border-border/50 bg-card p-6 shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5 md:p-8">
                    ...
                    <p className="text-[15px] leading-[1.7] text-muted-foreground md:text-base font-sans">{item.text}</p>
                  </div>
                )}
              </div>
