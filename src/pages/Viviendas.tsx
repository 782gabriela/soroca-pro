    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="bg-gradient-to-b from-primary/5 to-background pt-20 pb-12 md:pt-28 md:pb-16">
          <div className="container mx-auto px-4">
            ...
            <div className="mx-auto max-w-3xl">
              <h1 className="mb-6 text-3xl font-extrabold leading-tight tracking-tight text-foreground md:text-5xl">{t.viviendas.title}</h1>
            </div>
          </div>
        </section>
        <section className="pb-8 md:pb-12">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-4xl overflow-hidden rounded-2xl shadow-md">
              <img src={viviendaImg} alt={t.viviendas.title} className="aspect-[16/9] w-full object-cover" />
            </div>
          </div>
        </section>
        <section className="py-8 md:py-12">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl">
              <p className="text-base font-normal leading-[1.75] text-foreground/90 md:text-lg" style={{ maxWidth: '780px' }}>{t.viviendas.description}</p>
            </div>
          </div>
        </section>
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-5xl">
              <div className="mb-2 text-sm font-semibold uppercase tracking-widest text-primary">{t.viviendas.serviciosRelacionados}</div>
              <h2 className="mb-10 text-2xl font-bold leading-snug text-foreground md:text-3xl">{t.viviendas.serviciosParaVivienda}</h2>
        ...
        <section className="py-16 md:py-20">
          <div className="container mx-auto px-4 text-center">
            <div className="mx-auto max-w-xl">
              ...
              <p className="mb-4 text-2xl font-bold text-foreground md:text-3xl">{t.viviendas.ctaTitle}</p>
              <p className="mx-auto mb-8 text-[15px] leading-[1.7] text-muted-foreground md:text-base">{t.viviendas.ctaDesc}</p>
              <Button size="lg" className="px-10 text-base" onClick={() => openBudgetModal()}>{t.viviendas.ctaButton}</Button>
            </div>
          </div>
        </section>
      </main>
