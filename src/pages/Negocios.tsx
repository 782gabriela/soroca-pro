    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="bg-muted/30 py-16 md:py-24">
          <div className="container mx-auto px-4">
            ...
            <div className="mx-auto max-w-3xl">
              <h1 className="mb-4 text-3xl font-bold text-foreground sm:text-4xl lg:text-5xl">Servicios para negocios y locales</h1>
              <p className="mb-8 text-lg leading-relaxed text-muted-foreground">
                Reformamos, adecuamos y mantenemos tu local comercial u oficina. Nos adaptamos a tus horarios para minimizar el impacto en tu actividad. Gestionamos todos los permisos y certificaciones necesarias para que puedas abrir o renovar tu negocio sin complicaciones.
              </p>
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl">
              <h2 className="mb-8 text-2xl font-bold text-foreground sm:text-3xl">¿Qué podemos hacer por tu negocio?</h2>
        ...
        <section className="bg-muted/30 py-16 md:py-20">
          <div className="container mx-auto px-4 text-center">
            <h2 className="mb-4 text-2xl font-bold text-foreground sm:text-3xl">¿Necesitas reformar tu local?</h2>
            <p className="mx-auto mb-8 max-w-lg text-muted-foreground">Cuéntanos tu proyecto y te preparamos un presupuesto a medida sin compromiso.</p>
