        ...
        <section className="bg-gradient-to-b from-primary/5 to-background pt-20 pb-12 md:pt-28 md:pb-16">
          <div className="container mx-auto px-4">
            ...
            <div className="mx-auto max-w-3xl">
              <h1 className="mb-6 text-3xl font-extrabold leading-tight tracking-tight text-foreground md:text-5xl">Servicios para negocios y locales</h1>
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-5xl">
              ...
              <h2 className="mb-10 text-2xl font-bold leading-snug text-foreground md:text-3xl">¿Qué podemos hacer por tu negocio?</h2>
