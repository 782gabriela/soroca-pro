    ...
    <div className="container relative mx-auto px-4">
      <div className="mx-auto max-w-3xl text-center">
        <h1 className="mb-6 text-3xl font-bold leading-tight tracking-tight text-primary-foreground sm:text-4xl md:text-5xl lg:text-[3.25rem] lg:leading-[1.15]">
          ...
          <span className="block text-primary-foreground/80 text-xl sm:text-2xl font-normal mt-3">Experiencia · Seriedad · Profesionalismo</span>
        </h1>
        <p className="mx-auto mb-10 max-w-2xl text-base leading-relaxed text-primary-foreground/75 sm:text-lg">Prestamos servicios a viviendas, comunidades y negocios.
